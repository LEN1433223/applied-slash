...
> **现状(2026-02,mod 1.2.0)**:本文件描述的**存储元件设计与实测数据仍然有效**(AE2 侧未改动)。
> 需注意的变更:1.1.0 的 5 把充能拔刀剑已整体删除,现为一把**数据包刀「莉莉」**;
> 充能器保留但改为"为**任意**拔刀剑充能",配置项已改名。见 README 与 `THIRD-PARTY-NOTICES.md`。
